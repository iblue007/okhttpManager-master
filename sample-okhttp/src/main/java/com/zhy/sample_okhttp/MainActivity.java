...
import com.dpzx.okhttpmanager.ApiUrlManager;
import com.dpzx.okhttpmanager.BaseNetParseUtil;
import com.dpzx.okhttpmanager.BaseNetRequestManager;
import com.dpzx.okhttpmanager.JsonGenericsSerializator;
import com.dpzx.okhttpmanager.ListUserCallback;
import com.dpzx.okhttpmanager.User;
...
//                .build()
//                .execute(new MyStringCallback());
        // BaseNetRequestManager.doPostRequest(view.getContext(),url,"7777",new MyStringCallback());
        try {
//            BaseNetRequestManager.doPostRequest(view.getContext(),
//                    ApiUrlManager.API_LOGIN_URL,
//                    BaseNetParseUtil.addCommmonPostRequestValue(view.getContext()),
//                    BaseNetParseUtil.parsePostData("account","18084725150","password","xuqunxing","imei",""),new MyStringCallback());

            BaseNetRequestManager.doGetRequest(view.getContext(),
                    ApiUrlManager.API_PHONE_EXIST_URL + BaseNetParseUtil.parseGetData("18084725150"),
                    BaseNetParseUtil.addCommmonGetRequestValue(view.getContext())
